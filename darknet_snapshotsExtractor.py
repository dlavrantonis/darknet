...
def parser():
    ...
    # parser.add_argument("--weights", default="yolov4-p6.weights", help="yolo weights path")
    # parser.add_argument("--config_file", default="./cfg/yolov4-p6.cfg",help="path to config file")
    # parser.add_argument("--data_file", default="./cfg/coco.data", help="path to data file")
    ...
    # parser.add_argument("--weights", default="/mnt/nanotests/yolov4-tiny-obj640.weights", help="yolo weights path")
    ...
    # parser.add_argument("--weights", default="yolov4-tiny-obj_CH.weights", help="yolo weights path")
    # parser.add_argument("--config_file", default="./cfgden/yolov4-tiny-objI.cfg",help="path to config file")
    # parser.add_argument("--data_file", default="./data/objPolemi.data", help="path to data file")
