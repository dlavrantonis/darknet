...
def main():
    ...
    output_dir = Path('/mnt/newDatasets/crowdhuman/crowdhuman-%s' % args.dim)
    if not output_dir.is_dir():
        raise SystemExit('ERROR: %s does not exist.' % output_dir.as_posix())

    rm_txts(output_dir)
    process('test', '/mnt/newDatasets/crowdhuman/annotation_val.odgt', output_dir)
    process('train', '/mnt/newDatasets/crowdhuman/annotation_train.odgt', output_dir)
